            ...
            <aside id="sidebar"
                ...
                <div
                    ...
                    <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                        <div
                            ...
                            <ul className="pb-2 space-y-2">
                                ...
                                <li>
                                    <Link href="/employer/dashboard" className="flex items-center p-2 text-base text-gray-900
                                rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                        <svg
                                ...
                                <li>
                                    <Link href="/employer/shift" className="flex items-center p-2 text-base text-gray-900
                                rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                        <svg
                                        ...
                                        <span className="ml-3" sidebar-toggle-item>Zmiany</span>
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <div
                        ...
                        <a data-tooltip-target="tooltip-settings" className="inline-flex justify-center
        p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700
                                    ...
                                    <a href="#"
                                       ...
                                       role="menuitem">
                                        <div className="inline-flex items-center">
                                            <svg className="h-3.5 w-3.5 rounded-full mr-2"
                                                 xmlns="http://www.w3.org/2000/svg"
