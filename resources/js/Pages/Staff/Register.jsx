...
export default function Register() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('staff.account.create'), {
            onSuccess: () => {
                console.log('created');
            },
            preserveScroll: true
    ...
    return (
        <GuestLayout>
            <section className="bg-white dark:bg-gray-900 h-screen flex items-center">
                <div className="container px-6 py-24 pt-96 md:pt-0 mx-auto lg:py-32">
                    <div className="lg:flex">
                        <div className="lg:w-1/2">
                            ...
                            <div className={'text-gray-600'}>
                                <p>Już coraz mniej czasu dzieli nas od startu!</p>
                                <p>Załóż swoje konto i wypełnij profil zawodowy, <br/> aby móc korzystać z serwisu od
                                    razu jak ruszymy.</p>
                            </div>
                        </div>
