const EmptyState = (
    {header, subheader, buttonAction, buttonTitle}
) => {
    return (
        <div className="w-full flex items-center flex-wrap justify-center gap-10">
            <div className="grid gap-4 w-100">
                ...
                <div>
                    <h2 className="text-center text-black text-lg font-semibold leading-7 pb-1">{header}</h2>
                    ...
                    </p>
                    {
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="w-full px-3 py-2 rounded-full border border-gray-300 text-gray-900 text-xs font-semibold leading-4">{buttonTitle}</button>
                        </div>
                    }
